        ...
        .save_draft(
            ...
            SaveDraftRequest {
                content_snapshot: json!({
                    "reading": {"passages": [{"id": "reading-1", "title": "Reading Passage 1", "blocks": [{"type": "SHORT_ANSWER", "stem": "Answer the question", "questions": [{"id": "q1", "prompt": "Q1", "correctAnswer": "A"}, {"id": "q2", "prompt": "Q2", "correctAnswer": "B"}]}]}]},
