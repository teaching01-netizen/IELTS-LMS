...
func scheduleProbeRows() *sqlmock.Rows {
	...
	return sqlmock.NewRows(cols).AddRow(
		"sched-1", "exam-1", "ielts", nil, "Exam", "P", "G", "v-1", "cohort", nil, now, now, 60, "online", "none", 0, nil, nil, nil, false, false, "scheduled", now, "admin", now, 1, nil, nil,
	)
}

// rosterPageRows builds full 43-column roster rows (scanStudentSessionRow
...
// module id and revision) the proctor merge orders projections by, and the
// attempt's unfinished SAT break stage (id, state, duration, pause, offer
// instant, deadline).
func rosterPageRows() *sqlmock.Rows {
	cols := []string{"id", "candidate_id", "candidate_name", "candidate_email", "schedule_id", "current_module", "phase", "integrity", "violations_snapshot", "exam_id", "exam_title", "updated_at", "proctor_status", "last_warning_id", "last_heartbeat_at", "last_heartbeat_status", "provider_key", "title", "module_key", "adaptive_role", "started_at", "paused_at", "allocated_seconds", "extension_seconds", "accumulated_paused_seconds", "revision", "id", "module_id", "revision", "id", "state", "duration_seconds", "accumulated_paused_seconds", "starts_at", "paused_at", "entry_starts_at", "deadline_at", "id", "module_id", "title", "entry_generation", "entry_starts_at", "entry_proctor_rearm_at"}
	return sqlmock.NewRows(cols).
		AddRow("att-3", "c3", "Cara", "c@x", "sched-1", "listening", "live", `{}`, `[]`, "exam-1", "Exam", time.Now().UTC(), "active", nil, nil, nil, "ielts", nil, nil, nil, nil, nil, nil, nil, nil, int64(3), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil).
		AddRow("att-2", "c2", "Bob", "b@x", "sched-1", "listening", "live", `{}`, `[]`, "exam-1", "Exam", time.Now().UTC(), "active", nil, nil, nil, "ielts", nil, nil, nil, nil, nil, nil, nil, nil, int64(2), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil).
		AddRow("att-1", "c1", "Ann", "a@x", "sched-1", "listening", "live", `{}`, `[]`, "exam-1", "Exam", time.Now().UTC(), "active", nil, nil, nil, "ielts", nil, nil, nil, nil, nil, nil, nil, nil, int64(1), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
}
