...
CREATE TABLE IF NOT EXISTS users (
    ...
    role VARCHAR(50) NOT NULL CHECK (role IN ('admin', 'admin_observer', 'builder', 'proctor', 'grader', 'student')),
...
CREATE TABLE IF NOT EXISTS user_sessions (
    ...
    role_snapshot VARCHAR(50) NOT NULL CHECK (role_snapshot IN ('admin', 'admin_observer', 'builder', 'proctor', 'grader', 'student')),
