...
describe('StudentProctoringProvider', () => {
  ...
  it('does not attempt fullscreen re-entry when touchend comes from highlightable text with active selection', async () => {
    Object.defineProperty(navigator, 'userAgent', {
      value:
        'Mozilla/5.0 (iPad; CPU OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
      configurable: true,
    ...
    try {
      act(() => {
        Object.defineProperty(document, 'fullscreenElement', { value: null, configurable: true });
        highlightSurface.dispatchEvent(new Event('touchend', { bubbles: true }));
      });
