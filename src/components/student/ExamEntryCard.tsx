...
export function ExamEntryCard({ config, examTitle, candidateName, candidateId, footer }: ExamEntryCardProps) {
        ...
        <div className="flex-1 space-y-6 overflow-y-auto p-4 md:p-6 lg:p-10">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 text-sm leading-relaxed text-gray-700">
              <p>Your exam timer will not begin while you are waiting. The timer will begin when the proctor starts the exam.</p>
