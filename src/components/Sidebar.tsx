...
import { BookOpen, Headphones, PenTool, MessageCircle, FlaskConical } from "lucide-react";
    ...
    <div className="w-56 bg-gray-50 border-r border-gray-100 flex flex-col h-full flex-shrink-0 shadow-sm">
      <div className="p-4 pt-6">
        <div className="flex items-center gap-3 px-2 mb-6">
          <div className="w-8 h-8 bg-gray-900 rounded-sm flex items-center justify-center text-white font-bold text-xs">
            IB
          </div>
          <div>
          ...
          {modules.map((mod) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`text-[10px] font-mono opacity-0 group-hover:opacity-100 transition-opacity text-gray-400`}
                >
                  ⌘{mod.shortcut}
                </span>
              </button>
