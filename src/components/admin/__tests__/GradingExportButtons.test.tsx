...
describe("GradingExportButtons", () => {
  test("renders the export menu and invokes the matching export callback", () => {
    ...
    expect(
      screen.queryByRole("menuitem", { name: /reading answers & scores/i })
    ...
    openMenu();
    expect(
      screen.getByRole("menuitem", { name: /act science answers & scores/i })
    ).toBeInTheDocument();
  ...
  test("shows only ACT Science export for an ACT Science session", () => {
    ...
    expect(
      screen.queryByRole("menuitem", { name: /reading manual check sheet/i })
    ).not.toBeInTheDocument();
    expect(
      screen.queryByRole("menuitem", { name: /listening answers & scores/i })
    ).not.toBeInTheDocument();
    expect(
      screen.queryByRole("menuitem", { name: /listening manual check sheet/i })
    ).not.toBeInTheDocument();
