...
export function SatResultDetailRoute() {
  ...
  const hasScaledTotal = summary.totalScore !== null;
      ...
      <div className="mt-5 border-b border-black/[0.065] pb-7">
        ...
        <div className="mt-2 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="sm:text-right">
            <p className="text-[52px] font-semibold leading-none tabular-nums tracking-[-0.055em] text-slate-950">{hasScaledTotal ? summary.totalScore : `${raw.correct}/${raw.questions}`}</p>
            <p className="mt-2 text-[9px] font-semibold uppercase tracking-[0.13em] text-slate-400">{hasScaledTotal ? 'Practice score' : 'Practice · raw score'}</p>
          </div>
        </div>
      </div>

      <section className="py-7" aria-labelledby="sat-performance-heading">
