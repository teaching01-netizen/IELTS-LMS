...
export interface ProctorAlert {
  ...
  /** Local ack timestamp (S3-C4): lets mergeById prefer a local acknowledge
   * over a server snapshot that carries no ack clock. */
  updatedAt?: string;
}
...
export type ViolationTriggerType =
  "violation_count" | "specific_violation_type" | "severity_threshold";
