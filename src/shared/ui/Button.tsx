...
export function Button({
  ...
  const variants = {
    ...
    warning: 'bg-amber-400 text-gray-900 hover:bg-amber-500 active:bg-amber-600 focus:ring-blue-600',
    ghost: 'bg-transparent text-gray-700 hover:bg-gray-100 active:bg-gray-200 focus:ring-gray-300',
    outline: 'bg-transparent text-gray-700 border-2 border-gray-300 hover:bg-gray-100 active:bg-gray-200 focus:ring-gray-300',
  };
