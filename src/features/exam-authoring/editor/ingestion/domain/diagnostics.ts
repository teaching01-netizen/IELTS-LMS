...
export const DIAGNOSTIC_CODES = {
  ...
  IMAGE_COUNT_LIMIT: "import.image.count-limit",
  IMAGE_AGGREGATE_SIZE: "import.image.aggregate-size",
...
export const DIAGNOSTIC_MESSAGES: Record<DiagnosticCode, string> = {
  ...
  "import.image.count-limit": "Only 5 images can be inserted at once.",
  "import.image.aggregate-size": "The pasted images are too large as a group.",
