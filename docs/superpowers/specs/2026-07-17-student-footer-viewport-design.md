...
The objective footer becomes one row. Question and part navigation remains horizontally scrollable on the left. The overall answered count, such as `0/40`, remains visible on the right and does not scroll with the question chips. The footer no longer renders a Finish button.
